Hey, I'm **Subhash Prem**

Full-Stack Developer • Data Science & AI Enthusiast

I build scalable web applications and data-driven systems — combining software engineering with analytics to solve real-world problems.

🔭 Currently
- Building full-stack applications with real-world use cases
- Exploring AI & data science in practical projects
- Working on systems that combine data + software for better decisions
